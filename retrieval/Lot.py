"""The class definition of the objects used to represent parking lots.
...
class Lot(object):
    ...
    def __init__(self, name, num_spots):
        """Sets the name, num_spots, and path attributes. Also calls auto_setup
    ...
    def auto_setup(self):
        """Calls setter functions for all_xml_addresses, num_snapshots, and
        all_snapshots.
        """
    ...
    def set_all_addresses(self):
        """Retrieves the .xml addresses of the lot's associated snapshots, and
        sets the attributes of all_xml_addresses, num_snapshots, and 
        initializes all_snapshots
        """
    ...
    def set_lot_snapshots(self):
        """Sets all_snapshots to contain Snapshot objects for each snapshot of
